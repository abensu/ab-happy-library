...
| 名称 | 字节数 | 说明
|------|-------|-----
| ID3V2 | -     | 【非必须】包含了作者，作曲，专辑等信息，长度不固定，扩展了 ID3V1 的信息量。
...
| ID3V1 | 128   | 【非必须】包含了作者，作曲，专辑等信息，长度为 128 BYTE。
...
**请注意！实际上，文件并不一定含有 ID3V1**

> 以下是另外一个含 ID3V1 的文件。。。

![数据](./source/1005.png)

从数据上可直观看出内容为：“TAG 163 key(Don't modify):L64FU3”
