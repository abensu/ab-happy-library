...
d_server.get( '/crlf/mock-search', ( request, response ) => {
    ...
    response.send( 302, null, {
        // Location : request.query.url // 正常跳转且无注入
        Location : mod_querystring.unescape( request.query.url ) // TypeError: The header content contains invalid characters，然后服务器挂逼了
    } );
